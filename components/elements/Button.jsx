    ...
    const getVariant = () => {
        switch (variant) {
            ...
            case "outline-primary":
                return "bg-white text-blue-500 border border-blue-500 hover:text-white hover:bg-blue-700  ";

            default:
                return "bg-blue-500 hover:bg-blue-700 hover:bg-gra text-white shadow shadow-blue-600/25 hover:shadow-blue-600/75";
        }
    };
    return (
        <button
